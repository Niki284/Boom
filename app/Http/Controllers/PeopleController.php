...
class PeopleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('people.index', compact('people', 'relations', 'spouses', 'search'));
    ...
    public function search(Request $request)
{
    ...
    {
        // $request->validate([
        //     'spouse_name' => 'required_without:spouse_id|string|max:255',
        //     'spouse_last_name' => 'required_without:spouse_id|string|max:255',
        ...
        //     $spouse = People::findOrFail($request->spouse_id);
        // } else {
