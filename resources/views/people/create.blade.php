...
<div class="creare  max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <form action="{{ route('people.store', ['parent_id' =>  $parent_id]) }}" multiple enctype="multipart/form-data" method="POST">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="file"class="w-full p-2 border border-gray-300 rounded mt-1" id="img" name="img" placeholder="img"require>
        </div>
