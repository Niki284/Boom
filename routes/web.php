...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/people/{people}/addhistory', [PeopleHistoryController::class, 'store'])->name('people.history.store');
    Route::delete('/people/{people}/history/{history}', [PeopleHistoryController::class, 'destroyHistory'])->name('people.history.destroy');
